...
public abstract class DD {
    ...
    public static final int NO_REPLACE    = 0; // don't prune
    public static final int REPLACE_LOW   = 1; // not implemented.
    public static final int REPLACE_HIGH  = 2; // not implemented.
    public static final int REPLACE_MIN   = 3;
    public static final int REPLACE_MAX   = 4;
    public static final int REPLACE_AVG   = 5;
    public static final int REPLACE_RANGE = 6; // not implemented.
    ...
    // public static int    PRUNE_TYPE       = NO_REPLACE; // no prune!
    // public static int    PRUNE_TYPE       = REPLACE_RANGE; // not implemented
    public static int    PRUNE_TYPE       = REPLACE_AVG;
    
    public static double PRUNE_PRECISION  = 1e-10; // initialized with a default value

    public static void setPruneType (int type) {
    	PRUNE_TYPE = type;
    }
    
    public static int getPruneType () {
    	return PRUNE_TYPE;
    }
    
    public static double getPrunePrecision() {
		return PRUNE_PRECISION;
	}

	public static void setPrunePrecision(double prunePrecision) {
		PRUNE_PRECISION = prunePrecision;
	}
