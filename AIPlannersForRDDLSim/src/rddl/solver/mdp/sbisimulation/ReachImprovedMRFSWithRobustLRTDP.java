...
public class ReachImprovedMRFSWithRobustLRTDP extends Policy {
	...
	private double EPSILON_MODEL_REDUCTION = 0.4d; // use 0.05 for the example_approx_givan
	...
	// Constructors
	public ReachImprovedMRFSWithRobustLRTDP() {
	}
