...
/**
 * Essa versão de TVI foi testada e alguns resultados foram apresentados em 
 * reunião para Leliane e Felipe Trevizan em reunião no dia 07/04/14
 * @author Felipe
 *
 */
public class ReachMRFSWithTopologicalValueIteration_old extends Policy {
	...
	// Constructors
	public ReachMRFSWithTopologicalValueIteration_old() {
	}
	...
	*/
	...
	public void valueIterationTimeInfo (Cronometro reachabilityTime, Cronometro bisimulationTime, Cronometro viTime, double reward) {
		...
		timeInfoContent.append("PLANNER_TIME=" + ((double) topologicalValueIterationTime.getTotalMilisegundos() / 1000.0d) + "\n");
	...
	public void roundEnd(double reward) {
		valueIterationTimeInfo (reachabilityTime, stochasticBisimulationTime, lrtdpTime, reward);
		/*
