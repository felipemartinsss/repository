...
public class ReachMRFSWithRobustLRTDPDot3 extends Policy {
	...
	private double EPSILON_MODEL_REDUCTION = 0.3d; // use 0.05 for the example_approx_givan
	...
	// Constructors
	public ReachMRFSWithRobustLRTDPDot3() {
	}
