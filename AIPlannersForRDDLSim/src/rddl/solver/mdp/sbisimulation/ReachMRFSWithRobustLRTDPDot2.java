...
public class ReachMRFSWithRobustLRTDPDot2 extends Policy {
	...
	private double EPSILON_MODEL_REDUCTION = 0.2d; // use 0.05 for the example_approx_givan
	...
	// Constructors
	public ReachMRFSWithRobustLRTDPDot2() {
	}
